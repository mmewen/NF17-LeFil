<div class="jumbotron">
	<h1>Remarques sur l'article <a href="?module=edition&page=consulter_article&article=<?php echo $article['article_id']; ?>"><?php echo $article['article_titre']; ?></a></h1>
</div>
<p>
Revenir à la <a href="?module=edition&page=gerer_articles">gestion des articles</a>
