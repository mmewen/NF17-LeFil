...
<div class="page-header"><h1><?php echo($article['article_titre']); ?> - gestion des mots-clés</h1>
...
foreach ($motscles as $motcle) {
	if (intval($motcle["indexart_article"]) == $id_article){
		echo(" <a href='?module=edition&page=supprimer_motcle_article&article=".$id_article."&id_mot_cle=".$motcle["motsclefs_id"]."' title='Supprimer le mot-clé'>");
...
<div style="width:25%;">
	<form action="?module=edition&page=ajouter_motcle_article&article=<?php echo($id_article); ?>" method="POST">
